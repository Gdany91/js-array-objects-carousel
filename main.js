/* Ciao ragazzi,Esercizio di oggi: Carosello Array di Oggettinome repo: js-array-objects-carouselConsegna:
...
for (let i = 0; i < images.length; i++) {
    itemsContent += '<div class="item active"><img class="size_img " src="${images[i]}" alt=""></div>';
    
}

item.innerHTML += itemsContent;
